...
<BODY>
<FORM NAME="myform" METHOD="POST" action="demo02/controlforw2.jsp" onSubmit="return checkLogin()">
    <TABLE align="center">
        <TR>
            <TD>
                <IMG src="demo02/image/Snap1.jpg">
                    ...
                    <TABLE width="100%" height="100%" border=0 cellPadding=0 cellSpacing=0>
                        ...
                        <TR vAlign=top>
                            ...
                            <TD align=left valign="middle"><A href="#"><INPUT name="submit" type="image"
                                                                              src="demo02/image/login.gif" width="101"
