...
$(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == "null") {
                    ...
                    $(".providerView #proCode").html(data.proCode);
                    $(".providerView #proName").html(data.proName);
                    $(".providerView #proContact").html(data.proContact);
                    $(".providerView #proPhone").html(data.proPhone);
                    $(".providerView #proFax").html(data.proFax);
                    $(".providerView #proDesc").html(data.proDesc);
                }
            }
        })
    });
    ...
    $(".modifyProvider").on("click", function () {
        var obj = $(this);
        window.location.href = path + "/provider/tomodify.html?proid=" + obj.attr("proid");
    });
