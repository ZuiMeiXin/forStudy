...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/provider/providerlist.html">
				...
				<a href="${pageContext.request.contextPath }/provider/addprovider.html">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
	...
	<div class="providerView">
		...
		<p><strong>联系人：</strong><span id="proContact"></span></p>
		<p><strong>联系电话：</strong><span id="proPhone"></span></p>
		<p><strong>传真：</strong><span id="proFax"></span></p>
